...
del /q build\SimpleSRecordTool.lib >nul 2>nul
del /q build\SimpleSRecordTool.exp >nul 2>nul
...
echo Clean complete. Preserved build\SimpleSRecordTool.exe and build\srecord_tool.ini.
...
echo Preserves build\SimpleSRecordTool.exe and build\srecord_tool.ini.
endlocal
